...
def f(X):
    """"Given a scalar X, return some value of (a real number)"""
    Y = (X - 1.5)**2 + 0.5
    print "X = {}, Y = {}".format(X, Y)
    return Y

def minima_object_function():
    Xguess = 2.0
...
def fit_poly(data, error_func, degree=3):
    ...
    Returns a polynomial that minimizes the error function.
